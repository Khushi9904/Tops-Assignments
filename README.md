# Tops-Assignments
SESSION 1 - Introduction to Databases &amp; Installation Topics: What is a Database, RDBMS, SQLDB Engines (MySQL, PostgreSQL, Oracle) Installing MySQL / SQL ServerUsing SQL Workbench or DB BrowserTrainer Depth:Explain why SQL is the backbone of analytics. Demo:Install MySQL? Create database analytics_db.
SESSION 2 - Basic SELECT & FROMTopics:SELECT columnl, column2SELECT "Renaming columns (AS keyword) Comments in SQLDemo: SELECT * FROM employees;
